      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          const int numWaypoints = points_xs.size();
          Eigen::VectorXd waypoints_xs(numWaypoints);
          Eigen::VectorXd waypoints_ys(numWaypoints);

          for(int i = 0; i < numWaypoints; ++i) {

            double dx = points_xs[i] - px;
            double dy = points_ys[i] - py;
          ...
          */
          ...
          v*=0.44704;   //Converting mph to mps
